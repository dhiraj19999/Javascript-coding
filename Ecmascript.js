...
to the scope of a block statement, or expression on which it is used, unlike 
the var keyword, which declares a variable globally, or locally to an entire function 
...
if(true){
    ...
    console.log(10) // var prints 10 
}

console.log(a) // here also prints 10 becuse var is global scope keyword
...
if(true){
    ...
    console.log(a) // let  prints 10 
}

console.log(a) // here let prints 20 becuse let  is block scope keyword

// same varible with let keyword not get overlap that is use of let.
...
console.log(a)// it prints error as a is already decleared
...
console.log(a)// it prints 10 becuse of global 




console.log(a)               /*or */  var a;

var a; /*it gives undefined*/ console.log(a) // it also gives undefined
...
let a; /*it gives cannot acces a without intilisation*/ 
...
// we canot use hoisting with let , but can with var
