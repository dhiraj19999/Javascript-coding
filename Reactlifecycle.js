...
getDerivedStateFromProps() method is called, which updates the state with the color from 
the favcol attribute, the favorite color is still rendered as yellow:
...
When the component has been mounted, a timer changes the state, and after one second, the favorite 
